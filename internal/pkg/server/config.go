...
// New returns a new instance of GenericCrawServer from the given config.
func (c CompletedConfig) New() (*GenericCrawServer, error) {
...
func LoadConfig(cfg string, defaultName string) {
	if cfg != "" {
		...
		viper.AddConfigPath("/etc/agri-price-crawler")
