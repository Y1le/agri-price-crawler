...
// GenericCrawServer contains state for an agri-price-crawler craw server.
// type GenericCrawServer gin.Engine.
type GenericCrawServer struct {
	middlewares []string
...
func initGenericCrawServer(s *GenericCrawServer) {
	// do some setup
...
func (s *GenericCrawServer) InstallAPIs() {
...
func (s *GenericCrawServer) Setup() {
...
func (s *GenericCrawServer) InstallMiddlewares() {
...
func (s *GenericCrawServer) Run() error {
...
func (s *GenericCrawServer) Close() {
...
func (s *GenericCrawServer) ping(ctx context.Context) error {
